class Zee5 {
    ...
    public static void main(String[] args) {
        ...
        displayRegionalMovies();
        displayOriginals();
        displayRomanticShows();
        displaySuspense();
        displayBiographies();
        displayClassicMovies();
    }


    static void displayRegionalMovies() {
    ...
    static void displayRomanticShows() {
    ...
    static void displayBiographies() {
    ...
    static void displayClassicMovies() {
